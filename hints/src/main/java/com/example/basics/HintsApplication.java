...
/*
	...
	* (CustomerService)
	*/
@TypeHint(typeNames = "com.example.basics.SimpleCustomerService", access = AccessBits.ALL)
...
public class HintsApplication {
	...
	ApplicationRunner reflectionRunner() {
		return args -> {
			var clazzName = "com.example" + "." + "basics.SimpleCustomerService";
	...
	ApplicationRunner jdkProxiesRunner() {
		return args -> {
			...
			var clazzName = "com.example.basics" + period + "OrderService";
			var clazz = Class.forName(clazzName);
	...
	ApplicationRunner aotProxiesRunner() {
		return args -> {
			var clazzName = "com.example" + "." + "basics.ConcreteOrderService";
